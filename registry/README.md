...
|---|---|---|
| `DOC-n` | Document read or verified | DOC-1 … DOC-7 |
...
| `T-<nn>` | Claim first recorded from DOC-7 (MFR Tenet #2) | T-01 … T-13 |
...
| `DISC-<nnn>` | Discrepancy ledger row | DISC-001 … DISC-006 |
| `PR-<nnn>` | Provenance chain | PR-001 … PR-010 |
| `EC1`–`EC5` | Explanation class (never `H1`–`H5` — see `04` MD-001) | fixed |
| `MD-<nnn>` | Methodological decision | MD-001 … MD-010 |
