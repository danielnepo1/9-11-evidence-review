...
| `no oath recorded, non-interview event` | The document records no oath **and** types the event as something other than an interview on its own form. Default label: **meeting memorandum**. Never "interview record" *(added 19 Sep 2026 for DOC-9)* |
...
| **DOC-9** | MFR — luncheon meeting with DCI Tenet, 23 Dec 2003 | `no oath recorded, non-interview event` | Printed p.1, **image-verified**: the event-type field reads "**Type of Event: Luncheon Meeting**", where DOC-7 and DOC-8 read "Interview". There is no "Additional notes: The witness was under oath" line, which both DOC-7 and DOC-8 carry. Exhaustive search of all three pages returns **zero** hits for `oath` and `sworn` | **Meeting memorandum.** Never "testimony", never "interview record", never "sworn". Statements by Tenet, McLaughlin, Moseman, Muller and Rousseau are all unsworn and are labelled by speaker |
...
**DOC-8's oath is carried, not fresh — and the front matter it rests on is now confirmed.** *(Contingency discharged 19 September 2026.)* This register recorded DOC-8's status as `oath: carried over` on the strength of its own front-matter sentence that 22 January 2004 was the witness's "first interview". [DISC-008](discrepancies.md#disc-008) held that open, because the ISCAP index lists a Tenet MFR of 23 December 2003 — and **eighteen U-rows inherited the contingency**. DOC-9 has now been read in full and image-verified 3/3: the 23 December 2003 event is typed by the Commission itself as a **luncheon meeting**, not an interview, and V-12 records from inside that meeting that the interviews were still prospective. The front matter is accurate and the register's entry for DOC-8 stands.

The distinction that follows is unaffected and is **not** closed over. The 28 January session records no administration of an oath — it records a reminder that an oath administered six days earlier still applied. No commissioner is recorded as administering anything, and Commissioner Roemer, who administered the 22 January oath, is **not** among the Commission participants listed for 28 January. Whether a reminder by staff carries the same procedural weight as administration by a commissioner is a question this project does not answer; it records the distinction and stops.

**Third parties in the room are never covered by the witness's oath.** In both DOC-7 and DOC-8, statements are attributed to CIA officials other than the witness — Moseman, Muller, Bonk, Rousseau/Russo — and to Commission staff. These are unsworn, and are labelled by speaker, never folded into "the witness said". In DOC-9 **every** speaker is unsworn, including the witness. DOC-8 makes the point unusually clearly at printed p.11, where the staff insert a bracketed note that a CIA official's recollection of a meeting is offered although "**Bonk was not present at the September 4th meeting**".
